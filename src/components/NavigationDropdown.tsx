  ...
  return (
    <div className="fixed top-4 right-4 z-50" ref={dropdownRef}>
      ...
      <button
        ...
        className={`group relative p-3 md:p-4 rounded-xl md:rounded-2xl shadow-2xl transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 ${
          isDarkMode 
      ...
      >
        <div className="flex items-center gap-2 md:gap-3">
          <div className={`p-2 rounded-xl transition-all duration-300 ${
            ...
            {isOpen ? (
              <X className="w-5 h-5 md:w-6 md:h-6 text-white animate-spin" />
            ) : (
              <Menu className="w-5 h-5 md:w-6 md:h-6 text-white animate-pulse" />
            )}
          </div>
      ...
      {isOpen && (
        <>
          ...
          {/* Menu */}
          <div className={`absolute top-full right-0 mt-2 md:mt-4 w-80 md:w-96 rounded-2xl md:rounded-3xl shadow-2xl overflow-hidden animate-slideInDown border-2 ${
            isDarkMode 
            ...
            {/* Navigation Items */}
            <div className="p-3 md:p-4 space-y-2 max-h-80 md:max-h-96 overflow-y-auto">
              {navItems.map((item, index) => {
                ...
                return (
                  <button
                    ...
                    className={`group relative w-full p-3 md:p-4 rounded-xl md:rounded-2xl font-semibold text-sm md:text-base
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 md:gap-4">
                      <div className={`p-2 md:p-3 rounded-lg md:rounded-xl transition-all duration-300 group-hover:scale-110 ${
                        isActive 
                          ? 'bg-white/20' 
                          : isDarkMode
                          ? 'bg-gray-600/50 group-hover:bg-green-600/50'
                      ...
                      <div className="flex-1 text-right">
                        <h4 className={`text-sm md:text-lg font-bold mb-0 md:mb-1 ${
                          isActive 
                            ? 'text-white' 
                            : isDarkMode
                            ? 'text-gray-200 group-hover:text-white'
                    ...
                    <div className={`absolute inset-0 rounded-xl md:rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-r ${item.gradient} blur-xl -z-10`}></div>
